...
project = 'Interbotix X-Series LoCoBots Documentation'
...
html_title = "Interbotix X-Series LoCoBot Documentation"
...
html_logo = "_images/logo_xslocobots.png"
...
html_context = {
    ...
    'github_repo': 'interbotix_xslocobots_docs', # Repo name
...
htmlhelp_basename = 'InterbotixXSLoCoBotsDocumentation'
